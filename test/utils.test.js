...
describe('Methods should return sane defaults when given no input', () => {
  it('convertFullwidthCharsToASCII()', () =>
  ...
  it('isCharJapanesePunctuation()', () =>
    expect(isCharJapanesePunctuation()).toBe(false));
  it('isCharEnglishPunctuation()', () =>
  ...
  it('romajiToHiragana() with no input', () =>
    expect(romajiToHiragana()).toBe(''));
  it('hiraganaToKatakana() with no input', () =>
    expect(hiraganaToKatakana()).toBe(''));
  it('katakanaToHiragana() with no input', () =>
...
describe('convertFullwidthCharsToASCII', () => {
  it('passes parameter tests', () => {
    expect(convertFullwidthCharsToASCII('come on ＦＨＱＷＨＧＡＤＳ')).toBe(
      'come on FHQWHGADS'
    );
    expect(convertFullwidthCharsToASCII('ＦＨＱＷＨＧＡＤＳ')).toBe(
      'FHQWHGADS'
    );
    expect(convertFullwidthCharsToASCII('ｆｈｑｗｈｇａｄｓ')).toBe(
      'fhqwhgads'
...
describe('isCharVowel', () => {
  it('passes parameter tests', () => {
    ...
    expect(isCharVowel('y' /* includes 'y' as a vowel by default */)).toBe(
      true
    );
...
describe('isCharConsonant', () => {
  it('passes parameter tests', () => {
    ...
    expect(isCharConsonant('y', false /* excludes 'y' as a consonant */)).toBe(
      false
    );
...
describe('isCharJapanesePunctuation', () => {
  it('passes parameter tests', () => {
    ...
    expect(EN_PUNC.every((char) => isCharJapanesePunctuation(char))).toBe(
      false
    );
    expect(isCharJapanesePunctuation('?')).toBe(false);
